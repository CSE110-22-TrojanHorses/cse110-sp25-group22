...
## Contributing
If you want to build/copy off this project, Below are guidelines on how to fork, clone, create branches, publish changes, and submit pull requests. We also outline styling practices using ESLint and Prettier in VS Code.
